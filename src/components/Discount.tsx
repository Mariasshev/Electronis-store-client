        ...
        <div className="row g-4 mt-1">
          <div className="col-12 col-sm-6 col-lg-3">
            <div className={styles.card}>
              ...
              <div className={styles.imgWrap}>
                <Image src="/img/discount/iphone14pro-gold.png" alt="iPhone 14 Pro" fill className={styles.img} />
              </div>
          ...
          <div className="col-12 col-sm-6 col-lg-3">
            <div className={styles.card}>
              ...
              <div className={styles.imgWrap}>
                <Image src="/img/discount/airpods-max.png" alt="AirPods Max" fill className={styles.img} />
              </div>
              <div className={styles.body}>
          ...
          <div className="col-12 col-sm-6 col-lg-3">
            <div className={styles.card}>
              ...
              <div className={styles.imgWrap}>
                <Image src="/img/discount/watch-s9.png" alt="Apple Watch" fill className={styles.img} />
              </div>
              <div className={styles.body}>
          ...
          <div className="col-12 col-sm-6 col-lg-3">
            <div className={styles.card}>
              ...
              <div className={styles.imgWrap}>
                <Image src="/img/discount/iphone14pro-1tb.png" alt="iPhone 14 Pro 1TB" fill className={styles.img} />
              </div>
              <div className={styles.body}>
